...
export default function Home() {
  return (
    <main className="min-h-screen overflow-y-hidden ">
      ...
      {/* o mnie */}
      <div>
        <h2 id="o-mnie" className='pt-16 text-center text-3xl'>O Mnie</h2>
      ...
      {/* usługi */}
      <div>
        <h2 id='uslugi' className='pt-16 text-center text-3xl'>Usługi</h2>
      ...
      {/* portfolio */}
      <div>
        <h2 id='portfolio' className='pt-16 text-center text-3xl'>Portfolio</h2>
      ...
      {/* opinie */}
      <div>
        <h2 id='opinie' className='pt-16 text-center text-3xl'>Opinie</h2>
